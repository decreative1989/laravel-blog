...
<head>
    ...
    <link rel="shortcut icon"
          href="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/assets/img/favicon.ico')}}"
          type="image/x-icon">
    ...
    <!-- Theme color -->
    <link id="switcher"
          href="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/css/theme-color/'.config('setting.frontend.template.css-theme','default-theme').'.css')}}"
          rel="stylesheet">
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- IMG BASED LOGO  -->
            <!-- <a class="navbar-brand" href="index.html"><img src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/logo.png')}}" alt="logo"></a> -->
            </div>
...
<section id="mu-slider">
    ...
    <div class="mu-slider-single">
        <div class="mu-slider-img">
            <figure>
                <img
                    src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/slider/1.jpg')}}"
                    alt="img">
            </figure>
        </div>
    ...
    <div class="mu-slider-single">
        <div class="mu-slider-img">
            <figure>
                <img
                    src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/slider/2.jpg')}}"
                    alt="img">
            </figure>
        </div>
        <div class="mu-slider-content">
    ...
    <div class="mu-slider-single">
        <div class="mu-slider-img">
            <figure>
                <img
                    src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/slider/3.jpg')}}"
                    alt="img">
            </figure>
        </div>
        <div class="mu-slider-content">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mu-about-us-right">
                                <a id="mu-abtus-video" href="https://www.youtube.com/embed/HN3pm9qYAUs"
                                   target="mutube-video">
                                    <img
                                        src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/about-us.jpg')}}"
                                        alt="img">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4 col-md-4  col-sm-6">
                                <div class="mu-single-feature">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus non dolorem
                                        excepturi libero itaque sint labore similique maxime natus eum.</p>
                                    <a href="#">Read More</a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                    ...
                    <div id="mu-latest-course-slide" class="mu-latest-courses-content">
                        <div class="col-lg-4 col-md-4 col-xs-12">
                            <div class="mu-latest-course-single">
                                <figure class="mu-latest-course-img">
                                    <a href="#"><img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/courses/1.jpg')}}"
                                            alt="img"></a>
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-12">
                            <div class="mu-latest-course-single">
                                <figure class="mu-latest-course-img">
                                    <a href="#"><img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/courses/2.jpg')}}"
                                            alt="img"></a>
                                    <figcaption class="mu-latest-course-imgcaption">
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-12">
                            <div class="mu-latest-course-single">
                                <figure class="mu-latest-course-img">
                                    <a href="#"><img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/courses/3.jpg')}}"
                                            alt="img"></a>
                                    <figcaption class="mu-latest-course-imgcaption">
                                        <a href="#">Academic</a>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3  col-sm-6">
                                <div class="mu-our-teacher-single">
                                    <figure class="mu-our-teacher-img">
                                        <img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/teachers/teacher-01.png')}}"
                                            alt="teacher img">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="mu-our-teacher-single">
                                    <figure class="mu-our-teacher-img">
                                        <img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/teachers/teacher-02.png')}}"
                                            alt="teacher img">
                                        <div class="mu-our-teacher-social">
                                            <a href="#"><span class="fa fa-facebook"></span></a>
                                            <a href="#"><span class="fa fa-twitter"></span></a>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="mu-our-teacher-single">
                                    <figure class="mu-our-teacher-img">
                                        <img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/teachers/teacher-03.png')}}"
                                            alt="teacher img">
                                        <div class="mu-our-teacher-social">
                                            <a href="#"><span class="fa fa-facebook"></span></a>
                                            <a href="#"><span class="fa fa-twitter"></span></a>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="mu-our-teacher-single">
                                    <figure class="mu-our-teacher-img">
                                        <img
                                            src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/teachers/teacher-04.png')}}"
                                            alt="teacher img">
                                        <div class="mu-our-teacher-social">
                                            <a href="#"><span class="fa fa-facebook"></span></a>
                                            <a href="#"><span class="fa fa-twitter"></span></a>
                ...
                <div class="mu-testimonial-area">
                    <div id="mu-testimonial-slide" class="mu-testimonial-content">
                            ...
                            <div class="mu-testimonial-quote">
                                <blockquote>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem rerum soluta
                                        aperiam blanditiis obcaecati eveniet aliquam consequatur nobis eaque id.</p>
                                </blockquote>
                            </div>
                            <div class="mu-testimonial-img">
                                <img
                                    src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/testimonial-1.png')}}"
                                    alt="img">
                            </div>
                        ...
                        <div class="mu-testimonial-item">
                            ...
                            <div class="mu-testimonial-img">
                                <img
                                    src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/testimonial-3.png')}}"
                                    alt="img">
                            </div>
                            <div class="mu-testimonial-info">
                                <h4>Rebaca Michel</h4>
                        ...
                        <div class="mu-testimonial-item">
                            ...
                            <div class="mu-testimonial-img">
                                <img
                                    src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/testimonial-2.png')}}"
                                    alt="img">
                            </div>
                            <div class="mu-testimonial-info">
                                <h4>Stev Smith</h4>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <article class="mu-blog-single-item">
                                    <figure class="mu-blog-single-img">
                                        <a href="#"><img
                                                src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/blog/blog-1.jpg')}}"
                                                alt="img"></a>
                                    ...
                                    <div class="mu-blog-description">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae ipsum non
                                            voluptatum eum repellendus quod aliquid. Vitae, dolorum voluptate quis
                                            repudiandae eos molestiae dolores enim.</p>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <article class="mu-blog-single-item">
                                    <figure class="mu-blog-single-img">
                                        <a href="#"><img
                                                src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/blog/blog-2.jpg')}}"
                                                alt="img"></a>
                                        <figcaption class="mu-blog-caption">
                                            <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                                        </figcaption>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <article class="mu-blog-single-item">
                                    <figure class="mu-blog-single-img">
                                        <a href="#"><img
                                                src="{{asset('frontend/'.config('setting.frontend.template.folder','varsity').'/assets/img/blog/blog-3.jpg')}}"
                                                alt="img"></a>
                                        <figcaption class="mu-blog-caption">
                                            <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                                        </figcaption>
